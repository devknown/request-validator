...
namespace Devknown\Validator;

use Devknown\Validator\Helpers\PdoTrait;
use Devknown\Validator\Helpers\MysqliTrait;
use Devknown\Validator\Helpers\RulesFactory;
use Devknown\Validator\Helpers\ValidatorFacade;
...
final class Validator
{
    ...
    private static $config = [
        BaseRule::CONFIG_ORM => '\Devknown\Validator\DbProviders\PhalconAdapter',
    ];
